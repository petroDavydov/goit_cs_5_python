...
time.sleep(3) # command for pause
# --------------------------
...
print(f"Перемішана колода(shuffle): {cards}")
print(f"Перемішана колода(shuffle): {cards[0]}")
# --------------------------

fruits = ['apple', 'banana', 'orange']
print(f"This is use random.choice: {random.choice(fruits)}")
# --------------------------
...
print(f"Команда (sample): {team}")


price = random.uniform(50, 100)
print(f"Випадкова ціна(uniform): {price:.2f}")
# ------------------------------
...
print(
    f"This is ceil_result, floor_result, trunc_result from number 3,7: {ceil_result, floor_result, trunc_result}")
# -------------------------

angle = math.radians(60)
print(f"This is radians of 60 deg: {angle}")

log_res = math.log(10,2)
print(f"This is logarithm 10 & 2: {log_res}")

sqrt_res = math.sqrt(9)
print(f"This is sqrt of 9: {sqrt_res}")
# -------------

compare_True = math.isclose(0.1 + 0.2, 0.3)
print(f"This is compare 2 numbers float: {compare_True}")

print(f"Compare numberth without isclose function: {0.1 + 0.2 == 0.3}")
